...
//--------------------------------
double biasF = 150;     // Смещение. Нужно для вычета веса самого чайника
double kF = 0.0077;    // Коэффициент. Отношение объема к значению с АЦП

double biasR = 850;     // Для правого датчика
double kR = 0.025;     // 

double biasL = 850;    // Для левого датчика
double kL = 0.025;    // 
